...
hist(steps_day$steps, main = paste("Total Steps Each Day"), col="deepskyblue3",xlab="Number of Steps")
```
...
```{r}
hist(steps_total$steps, main = paste("Total Steps Each Day"), col="deepskyblue", xlab="Number of Steps")

hist(steps_day$steps, main = paste("Total Steps Each Day"), col="deepskyblue3", xlab="Number of Steps", add=T)
legend("topright", c("Imputed", "Non-imputed"), col=c("deepskyblue", "deepskyblue3"), lwd=10)
```
